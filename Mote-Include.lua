...
function precast(spell)
    ...
    if  player.main_job == "SCH" and (buffactive['Dark Arts'] or buffactive['Addendum: Black']) and (spell.skill == "Elemental Magic" or spell.skill == "Dark Magic" or spell.skill == "Enfeebling Magic") then 
        equip(sets.precast.FC['Elemental Magic'],{head=gear.SCHRelic.Head, feet=gear.SCHAF.Feet})
	elseif player.main_job == "SCH" and (buffactive['Light Arts'] or buffactive['Addendum: White']) and (spell.skill == "Healing Magic" or spell.skill == "Divine Magic" or spell.skill == "Enfeebling Magic" or spell.skill == "Enhancing Magic") then
		equip(sets.precast.FC['Healing Magic'],{head=gear.SCHRelic.Head, legs=gear.SCHAF.Legs, feet=gear.SCHAF.Feet})
	end
end
...
function midcast(spell)
	...
	if player.main_job == "SCH" and (buffactive['Dark Arts'] or buffactive['Addendum: Black']) and (spell.skill == "Enfeebling Magic") then 	  
		equip(sets.midcast['Enfeebling Magic'],{body=gear.SCHAF.Body})
	elseif player.main_job == "SCH" and (buffactive['Light Arts'] or buffactive['Addendum: White']) and (spell.skill == "Divine Magic") then
		equip(sets.midcast.FC['Divine Magic'],{legs=SCHAF.Legs})
	end
end
...
function apply_kiting(baseSet)
	...
	elseif player.status == 'Idle' and moving and state.DefenseMode.value == 'None' and (state.IdleMode.value == 'Normal' or state.IdleMode.value == 'Sphere') then
		if sets.Kiting then
		baseSet = set_combine(baseSet, sets.Kiting)
		end
    end
