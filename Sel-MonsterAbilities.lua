...
StunAbility = 	  S{"Fulmination", "Breakga", "Death Scissors", "Hell Scissors",
					...
					"Cruel Joke","Seismostomp","Torpid Glare","Raksha: Vengeance","Raksha: Judgment","Danse Macabre", "Gates of Hades",
					"Acheron Flame","No Quarter","Just Desserts",
				   }

					-- "Dreadstorm","Plague Swipe","Tenebrous Mist",
					
--List of moves to activate physical defense on.
					
PhysicalAbility = S{"Ripper Fang", "Chomp Rush", "Scythe Tail", "Cyclotail", "Delta Thrust", "Torpefying Charge",
					...
					"From The Skies", "Wild Horn", "Amnesic Blast", "Incensed Pummel",
				   }

--List of moves to activate magical defense on.
					
MagicalAbility = S{"Stone III", "Stone IV", "Stone V", "Stone VI", "Stonega III", "Stonega IV", "Stonega V","Stonega V", "Stoneja", "Quake", "Quake II",
					...
					"Aero III", "Aero IV", "Aero V", "Aero VI", "Aeroga III", "Aeroga IV", "Aeroga V", "Aeroja", "Tornado", "Tornado II",
					...
					"Thunderstorm", "Heavenly Strike", "Whirling Inferno", "Foul Breath", "Tetsudo Tremor", "Palsynyxis", "Leeching Current", "Meteor",
					"Venom Shower", "Marine Mayhem", "Tidal Guillotine", "Leafstorm", "Fulmination", "Hell Scissors", "Death", "Ecliptic Meteor",
					"Stygian Release", "Atramentous Libations", "Dragon Breath",
				  }
					
--List of moves to activate resist defense on.
					
ResistAbility = S{"Death", "Frond Fatale", "Atropine Spore", "Deracinator", "Cruel Joke","Paralyga","Break","Breakga","Bad Breath","Sweet Breath",
					"Sleep","Sleepga","Sleepga II","Bindga","Torpid Glare","Danse Macabre","Stalking Prey","Hemocladis","Mayhem Lantern",
				 }
